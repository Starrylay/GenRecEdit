...
from genrec.models.LETTER.layers import MLPLayers
from genrec.models.LETTER.rq import ResidualVectorQuantizer
...
class RQVAE(nn.Module):
    ...
    def __init__(self,
        ...
        self.cf_embedding = torch.from_numpy(cf_embedding).to(device)
        self.cf_embedding.requires_grad_(False)
