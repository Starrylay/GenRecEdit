...
class AmazonReviews2014(AbstractDataset):
    ...
    def _process_meta(
        ...
        # ipdb> item2meta["B00LFPS0CY"].keys()
        # dict_keys(['asin', 'categories', 'description', 'title', 'price', 'salesRank', 'imUrl', 'related'])
        # import ipdb; ipdb.set_trace()
        if process_mode == 'raw':
            pass
    ...
    def _download_and_process_raw(self):
        ...
        # import ipdb; ipdb.set_trace()  #ipdb> len(self.all_item_seqs[list(self.all_item_seqs.keys())[4]]) 27
